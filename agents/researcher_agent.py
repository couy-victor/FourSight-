...
from utils import search_web, search_arxiv, extract_text_from_pdf_url, summarize_pdf, call_groq_api, RagBM25
...
class ResearcherAgent:
    ...
    def __init__(self, use_arxiv=True, use_web=True, use_rag_bm25=True):
        """
        ...
        Args:
            ...
            use_rag_bm25: Se True, usa RAG BM25 para processamento de PDFs
        """
        self.use_arxiv = use_arxiv
        self.use_web = use_web
        self.use_rag_bm25 = use_rag_bm25
        self.research_results = []

        # Inicializar o sistema RAG BM25 se habilitado
    ...
    def research(self, topic: str, max_results: int = 5, business_context: str = "") -> List[Dict[str, Any]]:
        """
        ...
        Args:
            ...
            business_context: Contexto de negócio para melhorar a relevância da pesquisa
        ...
        if self.use_arxiv:
            arxiv_results = self._search_arxiv(topic, max_results, context=business_context)
    ...
    def _search_arxiv(self, query: str, max_results: int = 5, context: str = "") -> List[Dict[str, Any]]:
        """
